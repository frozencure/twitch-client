...
title: SUBS -
---
//[twitch-client](../../../index.md)/[helix.channels.model.hypetrain](../../index.md)/[ContributionType](../index.md)/[SUBS](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.channels.model.hypetrain/ContributionType.SUBS/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.channels.model.hypetrain/ContributionType.SUBS/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.channels.model.hypetrain/ContributionType.SUBS/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.channels.model.hypetrain/ContributionType.SUBS/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
