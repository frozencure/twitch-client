...
title: BITS -
---
//[twitch-client](../../../index.md)/[helix.channels.model.hypetrain](../../index.md)/[ContributionType](../index.md)/[BITS](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.channels.model.hypetrain/ContributionType.BITS/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.channels.model.hypetrain/ContributionType.BITS/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.channels.model.hypetrain/ContributionType.BITS/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.channels.model.hypetrain/ContributionType.BITS/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
