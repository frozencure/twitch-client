...
title: PROGRESSION -
---
//[twitch-client](../../../index.md)/[helix.channels.model.hypetrain](../../index.md)/[HypeTrainType](../index.md)/[PROGRESSION](index.md)



# PROGRESSION  
 [jvm] [PROGRESSION](index.md)()  
...
| [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)| [jvm]  <br>Content  <br>operator override fun [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)(other: [HypeTrainType](../index.md)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.channels.model.hypetrain/HypeTrainType.PROGRESSION/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.channels.model.hypetrain/HypeTrainType.PROGRESSION/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.channels.model.hypetrain/HypeTrainType.PROGRESSION/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.channels.model.hypetrain/HypeTrainType.PROGRESSION/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
