...
title: MOBILE -
---
//[twitch-client](../../../index.md)/[helix.extensions.model](../../index.md)/[ExtensionType](../index.md)/[MOBILE](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.extensions.model/ExtensionType.MOBILE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.extensions.model/ExtensionType.MOBILE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.extensions.model/ExtensionType.MOBILE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.extensions.model/ExtensionType.MOBILE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
