...
title: OVERLAY -
---
//[twitch-client](../../../index.md)/[helix.extensions.model](../../index.md)/[ExtensionType](../index.md)/[OVERLAY](index.md)



# OVERLAY  
 [jvm] [OVERLAY](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.extensions.model/ExtensionType.OVERLAY/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.extensions.model/ExtensionType.OVERLAY/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.extensions.model/ExtensionType.OVERLAY/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.extensions.model/ExtensionType.OVERLAY/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
