...
title: PANEL -
---
//[twitch-client](../../../index.md)/[helix.extensions.model](../../index.md)/[ExtensionType](../index.md)/[PANEL](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.extensions.model/ExtensionType.PANEL/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.extensions.model/ExtensionType.PANEL/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.extensions.model/ExtensionType.PANEL/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.extensions.model/ExtensionType.PANEL/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
