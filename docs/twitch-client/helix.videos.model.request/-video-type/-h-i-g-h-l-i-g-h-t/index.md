...
title: HIGHLIGHT -
---
//[twitch-client](../../../index.md)/[helix.videos.model.request](../../index.md)/[VideoType](../index.md)/[HIGHLIGHT](index.md)



# HIGHLIGHT  
 [jvm] [HIGHLIGHT](index.md)("highlight")  
...
|  Name|  Summary| 
|---|---|
| [asString](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/asString/#/PointingToDeclaration/)|  [jvm] override val [asString](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/asString/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model.request/VideoType.HIGHLIGHT/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
