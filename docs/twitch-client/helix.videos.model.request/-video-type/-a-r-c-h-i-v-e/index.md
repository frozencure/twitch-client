...
title: ARCHIVE -
---
//[twitch-client](../../../index.md)/[helix.videos.model.request](../../index.md)/[VideoType](../index.md)/[ARCHIVE](index.md)



# ARCHIVE  
 [jvm] [ARCHIVE](index.md)("archive")  
...
|  Name|  Summary| 
|---|---|
| [asString](index.md#helix.videos.model.request/VideoType.ARCHIVE/asString/#/PointingToDeclaration/)|  [jvm] override val [asString](index.md#helix.videos.model.request/VideoType.ARCHIVE/asString/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#helix.videos.model.request/VideoType.ARCHIVE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model.request/VideoType.ARCHIVE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model.request/VideoType.ARCHIVE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model.request/VideoType.ARCHIVE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
