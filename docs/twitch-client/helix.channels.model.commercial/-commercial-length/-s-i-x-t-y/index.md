...
title: SIXTY -
---
//[twitch-client](../../../index.md)/[helix.channels.model.commercial](../../index.md)/[CommercialLength](../index.md)/[SIXTY](index.md)



# SIXTY  
 [jvm] [SIXTY](index.md)(60)  
...
|  Name|  Summary| 
|---|---|
| [length](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/length/#/PointingToDeclaration/)|  [jvm] override val [length](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/length/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [name](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.channels.model.commercial/CommercialLength.SIXTY/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
