...
title: ADMIN -
---
//[twitch-client](../../../index.md)/[helix.users.model](../../index.md)/[UserType](../index.md)/[ADMIN](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.users.model/UserType.ADMIN/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.users.model/UserType.ADMIN/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.users.model/UserType.ADMIN/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.users.model/UserType.ADMIN/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
