...
title: GLOBAL_MOD -
---
//[twitch-client](../../../index.md)/[helix.users.model](../../index.md)/[UserType](../index.md)/[GLOBAL_MOD](index.md)



# GLOBAL_MOD  
 [jvm] [GLOBAL_MOD](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.users.model/UserType.GLOBAL_MOD/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.users.model/UserType.GLOBAL_MOD/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.users.model/UserType.GLOBAL_MOD/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.users.model/UserType.GLOBAL_MOD/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
