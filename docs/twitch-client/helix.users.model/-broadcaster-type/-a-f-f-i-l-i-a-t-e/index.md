...
title: AFFILIATE -
---
//[twitch-client](../../../index.md)/[helix.users.model](../../index.md)/[BroadcasterType](../index.md)/[AFFILIATE](index.md)



# AFFILIATE  
 [jvm] [AFFILIATE](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.users.model/BroadcasterType.AFFILIATE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.users.model/BroadcasterType.AFFILIATE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.users.model/BroadcasterType.AFFILIATE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.users.model/BroadcasterType.AFFILIATE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
