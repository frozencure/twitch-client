...
title: PARTNER -
---
//[twitch-client](../../../index.md)/[helix.users.model](../../index.md)/[BroadcasterType](../index.md)/[PARTNER](index.md)



# PARTNER  
 [jvm] [PARTNER](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.users.model/BroadcasterType.PARTNER/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.users.model/BroadcasterType.PARTNER/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.users.model/BroadcasterType.PARTNER/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.users.model/BroadcasterType.PARTNER/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
