---
title: ANALYTICS_READ_GAMES -
---
//[twitch-client](../../../index.md)/[helix.auth.model](../../index.md)/[AuthScope](../index.md)/[ANALYTICS_READ_GAMES](index.md)



# ANALYTICS_READ_GAMES  
 [jvm] View analytics data for your games.  
  
[ANALYTICS_READ_GAMES](index.md)("analytics:read:games")  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [scope](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/scope/#/PointingToDeclaration/)|  [jvm] override val [scope](index.md#helix.auth.model/AuthScope.ANALYTICS_READ_GAMES/scope/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
