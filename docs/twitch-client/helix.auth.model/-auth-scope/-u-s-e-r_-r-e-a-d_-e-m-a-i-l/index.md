---
title: USER_READ_EMAIL -
---
//[twitch-client](../../../index.md)/[helix.auth.model](../../index.md)/[AuthScope](../index.md)/[USER_READ_EMAIL](index.md)



# USER_READ_EMAIL  
 [jvm] Read authorized user’s email address.  
  
[USER_READ_EMAIL](index.md)("user:read:email")  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [scope](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/scope/#/PointingToDeclaration/)|  [jvm] override val [scope](index.md#helix.auth.model/AuthScope.USER_READ_EMAIL/scope/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
