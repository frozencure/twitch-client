---
title: CHANNEL_EDIT_COMMERCIAL -
---
//[twitch-client](../../../index.md)/[helix.auth.model](../../index.md)/[AuthScope](../index.md)/[CHANNEL_EDIT_COMMERCIAL](index.md)



# CHANNEL_EDIT_COMMERCIAL  
 [jvm] Start a commercial programmatically on the given channel.  
  
[CHANNEL_EDIT_COMMERCIAL](index.md)("channel:edit:commercial")  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [scope](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/scope/#/PointingToDeclaration/)|  [jvm] override val [scope](index.md#helix.auth.model/AuthScope.CHANNEL_EDIT_COMMERCIAL/scope/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
