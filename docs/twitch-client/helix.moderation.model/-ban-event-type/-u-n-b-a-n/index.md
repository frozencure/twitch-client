...
title: UNBAN -
---
//[twitch-client](../../../index.md)/[helix.moderation.model](../../index.md)/[BanEventType](../index.md)/[UNBAN](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.moderation.model/BanEventType.UNBAN/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.moderation.model/BanEventType.UNBAN/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.moderation.model/BanEventType.UNBAN/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.moderation.model/BanEventType.UNBAN/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
