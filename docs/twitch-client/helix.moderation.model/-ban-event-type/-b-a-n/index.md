...
title: BAN -
---
//[twitch-client](../../../index.md)/[helix.moderation.model](../../index.md)/[BanEventType](../index.md)/[BAN](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.moderation.model/BanEventType.BAN/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.moderation.model/BanEventType.BAN/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.moderation.model/BanEventType.BAN/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.moderation.model/BanEventType.BAN/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
