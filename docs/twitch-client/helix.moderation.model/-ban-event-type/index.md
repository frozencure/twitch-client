...
title: BanEventType -
---
//[twitch-client](../../index.md)/[helix.moderation.model](../index.md)/[BanEventType](index.md)



# BanEventType  
 [jvm] enum [BanEventType](index.md) : [Enum](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/index.html)   
...
|  Name|  Summary| 
|---|---|
| [BAN](-b-a-n/index.md)|  [jvm] [BAN](-b-a-n/index.md)()  <br>  <br>   <br>
| [UNBAN](-u-n-b-a-n/index.md)|  [jvm] [UNBAN](-u-n-b-a-n/index.md)()  <br>  <br>   <br>
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.moderation.model/BanEventType/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.moderation.model/BanEventType/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.moderation.model/BanEventType/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.moderation.model/BanEventType/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
