...
title: ADD -
---
//[twitch-client](../../../index.md)/[helix.moderation.model](../../index.md)/[ModeratorEventType](../index.md)/[ADD](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.moderation.model/ModeratorEventType.ADD/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.moderation.model/ModeratorEventType.ADD/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.moderation.model/ModeratorEventType.ADD/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.moderation.model/ModeratorEventType.ADD/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
