...
title: REMOVE -
---
//[twitch-client](../../../index.md)/[helix.moderation.model](../../index.md)/[ModeratorEventType](../index.md)/[REMOVE](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.moderation.model/ModeratorEventType.REMOVE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.moderation.model/ModeratorEventType.REMOVE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.moderation.model/ModeratorEventType.REMOVE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.moderation.model/ModeratorEventType.REMOVE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
