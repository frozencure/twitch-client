...
title: HIGHLIGHT -
---
//[twitch-client](../../../index.md)/[helix.videos.model](../../index.md)/[VideoType](../index.md)/[HIGHLIGHT](index.md)



# HIGHLIGHT  
 [jvm] [HIGHLIGHT](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.videos.model/VideoType.HIGHLIGHT/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model/VideoType.HIGHLIGHT/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model/VideoType.HIGHLIGHT/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model/VideoType.HIGHLIGHT/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
