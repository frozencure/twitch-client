...
title: ARCHIVE -
---
//[twitch-client](../../../index.md)/[helix.videos.model](../../index.md)/[VideoType](../index.md)/[ARCHIVE](index.md)



# ARCHIVE  
 [jvm] [ARCHIVE](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.videos.model/VideoType.ARCHIVE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model/VideoType.ARCHIVE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model/VideoType.ARCHIVE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model/VideoType.ARCHIVE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
