...
title: PRIVATE -
---
//[twitch-client](../../../index.md)/[helix.videos.model](../../index.md)/[VideoVisibility](../index.md)/[PRIVATE](index.md)



# PRIVATE  
 [jvm] [PRIVATE](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.videos.model/VideoVisibility.PRIVATE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model/VideoVisibility.PRIVATE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model/VideoVisibility.PRIVATE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model/VideoVisibility.PRIVATE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
