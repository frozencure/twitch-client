---
title: VideoVisibility -
---
//[twitch-client](../../index.md)/[helix.videos.model](../index.md)/[VideoVisibility](index.md)



# VideoVisibility  
 [jvm] enum [VideoVisibility](index.md) : [Enum](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/index.html)   
...
|  Name|  Summary| 
|---|---|
| [PUBLIC](-p-u-b-l-i-c/index.md)|  [jvm] [PUBLIC](-p-u-b-l-i-c/index.md)()  <br>  <br>   <br>
| [PRIVATE](-p-r-i-v-a-t-e/index.md)|  [jvm] [PRIVATE](-p-r-i-v-a-t-e/index.md)()  <br>  <br>   <br>
...
|  Name|  Summary| 
|---|---|
| [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)| [jvm]  <br>Content  <br>operator override fun [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)(other: [VideoVisibility](index.md)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [name](index.md#helix.videos.model/VideoVisibility/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.videos.model/VideoVisibility/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.videos.model/VideoVisibility/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.videos.model/VideoVisibility/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
