...
title: MONTH -
---
//[twitch-client](../../../index.md)/[helix.shared.model.request](../../index.md)/[Period](../index.md)/[MONTH](index.md)



# MONTH  
 [jvm] [MONTH](index.md)("month")  
...
|  Name|  Summary| 
|---|---|
| [asString](index.md#helix.shared.model.request/Period.MONTH/asString/#/PointingToDeclaration/)|  [jvm] override val [asString](index.md#helix.shared.model.request/Period.MONTH/asString/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#helix.shared.model.request/Period.MONTH/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#helix.shared.model.request/Period.MONTH/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#helix.shared.model.request/Period.MONTH/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#helix.shared.model.request/Period.MONTH/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
